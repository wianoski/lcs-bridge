                    ...
                    avatar={
                        <Avatar
                            className={props.privilege > 2 ? (
                                props.data.status === 1 ? classes.danger : props.data.status === 2 ? classes.warning : props.data.status === 3 ? classes.healthy : props.data.status === 4 ? classes.maintenance : props.data.status === 5 ? classes.danger : ''
                            ) : (
                                    props.data.status === 1 ? classes.danger : props.data.status === 2 ? classes.warning : props.data.status === 3 ? classes.healthy : props.data.status === 4 ? classes.maintenance : props.data.status === 5 ? classes.sensor : ''
                                )
                            }
                        >
                            {
