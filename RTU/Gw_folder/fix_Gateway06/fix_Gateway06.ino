...
uint8_t data1[] = "REQ_RTU04_1";
uint8_t data2[] = "REQ_RTU04_2";
uint8_t data3[] = "REQ_RTU04_3";
uint8_t data4[] = "REQ_RTU04_4";
...
//  Serial.println(conId,freqId,gwId,rtuId,stat);
  Serial.println("con01,04110,gw06,RTU_04,1000,05,ready");
}
...
void request_RTU06() {
  ...
  if (manager.sendtoWait(data1, sizeof(data1), CLIENT_ADDRESS)) {
    // Now wait for a reply from the RTU06
